                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-9 col-lg-8 mx-auto">
                                ...
                                <form action="<?php echo site_url('lupa_password/index') ?>" method="post">
                                    ...
                                    <button class="btn btn-lg btn-default btn-block btn-login text-uppercase font-weight-bold mb-2 btn-signin" type="submit">Confirm</button>

                                </form>
                                <div class="text-center">
                                    <a class="small link-red" href="<?php echo base_url();  ?>login/register">Doesn't have account? Register
                                        now</a>
                                </div>
                                <div class="text-center">
                                    <a class="small link-red" href="<?php echo base_url();  ?>login">Have account? Login
                                        now</a>
                                </div>
                            </div>
                        </div>
